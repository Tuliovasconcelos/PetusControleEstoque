      ...
      <div class="card-body">
        ...
        <form method="POST" action="valida/valida_login.php">
          <div class="form-group">
            ...
            <center>
              <img src="imagens/logo_index.png" style="width:45%; margin-top:-15%; margin-bottom:-10%">
            </center>
          ...
          <button type="submit" name="entrar" style="width:100% ; background-color:#e67e00; color:white" class="btn">Entrar </button>
        </form>
        <div class="text-center"><br>
          <a style="color:#e67e00" class="d-block small" href="forgot-password.html">Perdeu sua senha?</a>
        </div>
      </div>
    </div>
  </div>
